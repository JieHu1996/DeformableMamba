...
from ..utils.dcnv3.modules import DCNv3
...
class HFBlock(nn.Module):
    ...
    def forward(self, x_deep, x_shallow):
        ...
        x_shallow = self.local_branch(x_shallow.permute(0, 2, 3, 1).contiguous()).permute(0, 3, 1, 2).contiguous()
...
class SegMambaHeadV61(BaseDecodeHead):
    def __init__(
        self,  
        depths=[2, 2, 2, 2], 
